...
namespace SharedTrip.Services
{
    public class UserService : IUserService
    {
        ...
        public void RegisterUser(RegisterViewModel model)
        {
            ...
            if (userExists)
            {
                throw new ArgumentException("Regstration failed");
            }
            User user = new User()
            {
                Email = model.Email,
            ...
            ValidateModel(RegisterViewModel model)
        {
                ...
                || model.UserName.Length > 20)
            {
                ...
                errors.Add(new ErrorViewModel
                    ("Username is requred and must be between 5 and 20 characters"));
            }
                ...
                || model.Password.Length > 20)
            {
                isValid = false;
                errors.Add(new ErrorViewModel
                    ("Password is requred and must be between 6 and 20 characters"));
            }
