...
namespace FootballManager.Services
{
    public class UserService : IUserService
    {
        ...
        public (bool isValid, IEnumerable<ErrorViewModel> errors) ValidateModel(RegisterViewModel model)
        {
            ...
            {
                isValid = false;
                errors.Add(new ErrorViewModel("Email is required and must be between 10 and 60 characters"));
            }
            ...
            {
                isValid = false;
                errors.Add(new ErrorViewModel("Password is requred and must be between 5 and 20 characters"));
            }
