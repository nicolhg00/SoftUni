...
namespace FestivalManager.Tests
{
    ...
    public class StageTests
    {
        ...
        [Test]
        public void PerformerAddedSuccessfulyAddPerformer()
        {
        ...
        {
            var song = new Song("white bunny", new TimeSpan(0, 0, 34));
            Assert.Throws(typeof(ArgumentException), () => stage.AddSong(song));
        }

        [Test]
        public void SongMustNobBeNullAddSongToPerformer()
        {
            Assert.Throws(typeof(ArgumentNullException), () => stage.AddSongToPerformer(null, "Pesho"));
            Assert.Throws(typeof(ArgumentNullException), () => stage.AddSongToPerformer("White", null));
        }
