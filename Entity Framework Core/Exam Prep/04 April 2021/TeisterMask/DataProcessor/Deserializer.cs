namespace TeisterMask.DataProcessor
{
    ...
    public class Deserializer
    {
        ...
        public static string ImportProjects(TeisterMaskContext context, string xmlString)
        {
            ...
            ImportProjectDto[] projectDtos = (ImportProjectDto[])xmlSerializer
                .Deserialize(sr);
            ...
            foreach (ImportProjectDto projectDto in projectDtos)
            {
                ...
                if (!String.IsNullOrWhiteSpace(projectDto.DueDate))
                {
                    ...
                    bool isDueDateValis = DateTime.TryParseExact(projectDto.DueDate,
                ...
                foreach (ImportProjectTaskDto taskDto in projectDto.Tasks)
                {
                    ...
                    bool isTaskOpenDateValid = DateTime.TryParseExact(taskDto.TaskOpenDate,
                        "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None,
                    ...
                    bool isTaskDueDateValid = DateTime.TryParseExact(taskDto.TaskDueDate,
                        "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None,
